...
local CancelAllMatchmakingTicketsForPlayer = TS.async(function(request)
	...
	local result = TS.await(MakeRequest('/Match/CancelAllMatchmakingTicketsForPlayer', request, 'X-EntityToken', Settings.settings.entityToken));
	return result;
end);
local CancelAllServerBackfillTicketsForPlayer = TS.async(function(request)
	...
	local result = TS.await(MakeRequest('/Match/CancelAllServerBackfillTicketsForPlayer', request, 'X-EntityToken', Settings.settings.entityToken));
	return result;
end);
local CancelMatchmakingTicket = TS.async(function(request)
	...
	local result = TS.await(MakeRequest('/Match/CancelMatchmakingTicket', request, 'X-EntityToken', Settings.settings.entityToken));
	return result;
end);
local CancelServerBackfillTicket = TS.async(function(request)
	...
	local result = TS.await(MakeRequest('/Match/CancelServerBackfillTicket', request, 'X-EntityToken', Settings.settings.entityToken));
	return result;
end);
local CreateMatchmakingTicket = TS.async(function(request)
	...
	local result = TS.await(MakeRequest('/Match/CreateMatchmakingTicket', request, 'X-EntityToken', Settings.settings.entityToken));
	return result;
end);
local CreateServerBackfillTicket = TS.async(function(request)
	...
	local result = TS.await(MakeRequest('/Match/CreateServerBackfillTicket', request, 'X-EntityToken', Settings.settings.entityToken));
	return result;
end);
local CreateServerMatchmakingTicket = TS.async(function(request)
	...
	local result = TS.await(MakeRequest('/Match/CreateServerMatchmakingTicket', request, 'X-EntityToken', Settings.settings.entityToken));
	return result;
end);
local GetMatchmakingQueue = TS.async(function(request)
	...
	local result = TS.await(MakeRequest('/Match/GetMatchmakingQueue', request, 'X-EntityToken', Settings.settings.entityToken));
	return result;
end);
local GetMatchmakingTicket = TS.async(function(request)
	...
	local result = TS.await(MakeRequest('/Match/GetMatchmakingTicket', request, 'X-EntityToken', Settings.settings.entityToken));
	return result;
end);
local GetQueueStatistics = TS.async(function(request)
	...
	local result = TS.await(MakeRequest('/Match/GetQueueStatistics', request, 'X-EntityToken', Settings.settings.entityToken));
	return result;
end);
local GetServerBackfillTicket = TS.async(function(request)
	...
	local result = TS.await(MakeRequest('/Match/GetServerBackfillTicket', request, 'X-EntityToken', Settings.settings.entityToken));
	return result;
end);
local JoinMatchmakingTicket = TS.async(function(request)
	...
	local result = TS.await(MakeRequest('/Match/JoinMatchmakingTicket', request, 'X-EntityToken', Settings.settings.entityToken));
	return result;
end);
local ListMatchmakingQueues = TS.async(function(request)
	...
	local result = TS.await(MakeRequest('/Match/ListMatchmakingQueues', request, 'X-EntityToken', Settings.settings.entityToken));
	return result;
end);
local ListMatchmakingTicketsForPlayer = TS.async(function(request)
	...
	local result = TS.await(MakeRequest('/Match/ListMatchmakingTicketsForPlayer', request, 'X-EntityToken', Settings.settings.entityToken));
	return result;
end);
local ListServerBackfillTicketsForPlayer = TS.async(function(request)
	...
	local result = TS.await(MakeRequest('/Match/ListServerBackfillTicketsForPlayer', request, 'X-EntityToken', Settings.settings.entityToken));
	return result;
end);
local RemoveMatchmakingQueue = TS.async(function(request)
	...
	local result = TS.await(MakeRequest('/Match/RemoveMatchmakingQueue', request, 'X-EntityToken', Settings.settings.entityToken));
	return result;
end);
local SetMatchmakingQueue = TS.async(function(request)
	...
	local result = TS.await(MakeRequest('/Match/SetMatchmakingQueue', request, 'X-EntityToken', Settings.settings.entityToken));
	return result;
end);
