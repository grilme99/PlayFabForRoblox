...
local CreateExperiment = TS.async(function(request)
	...
	local result = TS.await(MakeRequest('/Experimentation/CreateExperiment', request, 'X-EntityToken', Settings.settings.entityToken));
	return result;
end);
local DeleteExperiment = TS.async(function(request)
	...
	local result = TS.await(MakeRequest('/Experimentation/DeleteExperiment', request, 'X-EntityToken', Settings.settings.entityToken));
	return result;
end);
local GetExperiments = TS.async(function(request)
	...
	local result = TS.await(MakeRequest('/Experimentation/GetExperiments', request, 'X-EntityToken', Settings.settings.entityToken));
	return result;
end);
local GetLatestScorecard = TS.async(function(request)
	...
	local result = TS.await(MakeRequest('/Experimentation/GetLatestScorecard', request, 'X-EntityToken', Settings.settings.entityToken));
	return result;
end);
local GetTreatmentAssignment = TS.async(function(request)
	...
	local result = TS.await(MakeRequest('/Experimentation/GetTreatmentAssignment', request, 'X-EntityToken', Settings.settings.entityToken));
	return result;
end);
local StartExperiment = TS.async(function(request)
	...
	local result = TS.await(MakeRequest('/Experimentation/StartExperiment', request, 'X-EntityToken', Settings.settings.entityToken));
	return result;
end);
local StopExperiment = TS.async(function(request)
	...
	local result = TS.await(MakeRequest('/Experimentation/StopExperiment', request, 'X-EntityToken', Settings.settings.entityToken));
	return result;
end);
local UpdateExperiment = TS.async(function(request)
	...
	local result = TS.await(MakeRequest('/Experimentation/UpdateExperiment', request, 'X-EntityToken', Settings.settings.entityToken));
	return result;
end);
