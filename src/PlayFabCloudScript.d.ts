...
declare module PlayFabCloudScriptModule {
    export interface IPlayFabCloudScript {
        ...
        ): Promise<PlayFabCloudScriptModels.ListFunctionsResult>;
        /**
        ...
        ListHttpFunctions(
            entityToken: string,
            request?: PlayFabCloudScriptModels.ListFunctionsRequest
        ): Promise<PlayFabCloudScriptModels.ListHttpFunctionsResult>;
        /**
        ...
        ListQueuedFunctions(
            entityToken: string,
            request?: PlayFabCloudScriptModels.ListFunctionsRequest
        ): Promise<PlayFabCloudScriptModels.ListQueuedFunctionsResult>;
        /**
        ...
        ): Promise<PlayFabCloudScriptModels.EmptyResult>;
        /**
         * Generate an entity PlayStream event for the provided function result.
