...
export const CancelAllMatchmakingTicketsForPlayer = async (request: CancelAllMatchmakingTicketsForPlayerRequest) => {
    ...
    const result = await MakeRequest<CancelAllMatchmakingTicketsForPlayerResult>('/Match/CancelAllMatchmakingTicketsForPlayer', request, 'X-EntityToken', Settings._internalSettings.entityToken)
    return result
}
...
export const CancelAllServerBackfillTicketsForPlayer = async (request: CancelAllServerBackfillTicketsForPlayerRequest) => {
    if (Settings._internalSettings.entityToken === '') throw 'Must have Settings._internalSettings.entityToken set to call this method'
    const result = await MakeRequest<CancelAllServerBackfillTicketsForPlayerResult>('/Match/CancelAllServerBackfillTicketsForPlayer', request, 'X-EntityToken', Settings._internalSettings.entityToken)
    return result
}
...
export const CancelMatchmakingTicket = async (request: CancelMatchmakingTicketRequest) => {
    if (Settings._internalSettings.entityToken === '') throw 'Must have Settings._internalSettings.entityToken set to call this method'
    const result = await MakeRequest<CancelMatchmakingTicketResult>('/Match/CancelMatchmakingTicket', request, 'X-EntityToken', Settings._internalSettings.entityToken)
    return result
}
...
export const CancelServerBackfillTicket = async (request: CancelServerBackfillTicketRequest) => {
    if (Settings._internalSettings.entityToken === '') throw 'Must have Settings._internalSettings.entityToken set to call this method'
    const result = await MakeRequest<CancelServerBackfillTicketResult>('/Match/CancelServerBackfillTicket', request, 'X-EntityToken', Settings._internalSettings.entityToken)
    return result
}
...
export const CreateMatchmakingTicket = async (request: CreateMatchmakingTicketRequest) => {
    if (Settings._internalSettings.entityToken === '') throw 'Must have Settings._internalSettings.entityToken set to call this method'
    const result = await MakeRequest<CreateMatchmakingTicketResult>('/Match/CreateMatchmakingTicket', request, 'X-EntityToken', Settings._internalSettings.entityToken)
    return result
}
...
export const CreateServerBackfillTicket = async (request: CreateServerBackfillTicketRequest) => {
    if (Settings._internalSettings.entityToken === '') throw 'Must have Settings._internalSettings.entityToken set to call this method'
    const result = await MakeRequest<CreateServerBackfillTicketResult>('/Match/CreateServerBackfillTicket', request, 'X-EntityToken', Settings._internalSettings.entityToken)
    return result
}
...
export const CreateServerMatchmakingTicket = async (request: CreateServerMatchmakingTicketRequest) => {
    if (Settings._internalSettings.entityToken === '') throw 'Must have Settings._internalSettings.entityToken set to call this method'
    const result = await MakeRequest<CreateMatchmakingTicketResult>('/Match/CreateServerMatchmakingTicket', request, 'X-EntityToken', Settings._internalSettings.entityToken)
    return result
}
...
export const GetMatchmakingQueue = async (request: GetMatchmakingQueueRequest) => {
    if (Settings._internalSettings.entityToken === '') throw 'Must have Settings._internalSettings.entityToken set to call this method'
    const result = await MakeRequest<GetMatchmakingQueueResult>('/Match/GetMatchmakingQueue', request, 'X-EntityToken', Settings._internalSettings.entityToken)
    return result
}
...
export const GetMatchmakingTicket = async (request: GetMatchmakingTicketRequest) => {
    if (Settings._internalSettings.entityToken === '') throw 'Must have Settings._internalSettings.entityToken set to call this method'
    const result = await MakeRequest<GetMatchmakingTicketResult>('/Match/GetMatchmakingTicket', request, 'X-EntityToken', Settings._internalSettings.entityToken)
    return result
}
...
export const GetQueueStatistics = async (request: GetQueueStatisticsRequest) => {
    if (Settings._internalSettings.entityToken === '') throw 'Must have Settings._internalSettings.entityToken set to call this method'
    const result = await MakeRequest<GetQueueStatisticsResult>('/Match/GetQueueStatistics', request, 'X-EntityToken', Settings._internalSettings.entityToken)
    return result
}
...
export const GetServerBackfillTicket = async (request: GetServerBackfillTicketRequest) => {
    if (Settings._internalSettings.entityToken === '') throw 'Must have Settings._internalSettings.entityToken set to call this method'
    const result = await MakeRequest<GetServerBackfillTicketResult>('/Match/GetServerBackfillTicket', request, 'X-EntityToken', Settings._internalSettings.entityToken)
    return result
}
...
export const JoinMatchmakingTicket = async (request: JoinMatchmakingTicketRequest) => {
    if (Settings._internalSettings.entityToken === '') throw 'Must have Settings._internalSettings.entityToken set to call this method'
    const result = await MakeRequest<JoinMatchmakingTicketResult>('/Match/JoinMatchmakingTicket', request, 'X-EntityToken', Settings._internalSettings.entityToken)
    return result
}
...
export const ListMatchmakingQueues = async (request: ListMatchmakingQueuesRequest) => {
    if (Settings._internalSettings.entityToken === '') throw 'Must have Settings._internalSettings.entityToken set to call this method'
    const result = await MakeRequest<ListMatchmakingQueuesResult>('/Match/ListMatchmakingQueues', request, 'X-EntityToken', Settings._internalSettings.entityToken)
    return result
}
...
export const ListMatchmakingTicketsForPlayer = async (request: ListMatchmakingTicketsForPlayerRequest) => {
    if (Settings._internalSettings.entityToken === '') throw 'Must have Settings._internalSettings.entityToken set to call this method'
    const result = await MakeRequest<ListMatchmakingTicketsForPlayerResult>('/Match/ListMatchmakingTicketsForPlayer', request, 'X-EntityToken', Settings._internalSettings.entityToken)
    return result
}
...
export const ListServerBackfillTicketsForPlayer = async (request: ListServerBackfillTicketsForPlayerRequest) => {
    if (Settings._internalSettings.entityToken === '') throw 'Must have Settings._internalSettings.entityToken set to call this method'
    const result = await MakeRequest<ListServerBackfillTicketsForPlayerResult>('/Match/ListServerBackfillTicketsForPlayer', request, 'X-EntityToken', Settings._internalSettings.entityToken)
    return result
}
...
export const RemoveMatchmakingQueue = async (request: RemoveMatchmakingQueueRequest) => {
    if (Settings._internalSettings.entityToken === '') throw 'Must have Settings._internalSettings.entityToken set to call this method'
    const result = await MakeRequest<RemoveMatchmakingQueueResult>('/Match/RemoveMatchmakingQueue', request, 'X-EntityToken', Settings._internalSettings.entityToken)
    return result
}
...
export const SetMatchmakingQueue = async (request: SetMatchmakingQueueRequest) => {
    if (Settings._internalSettings.entityToken === '') throw 'Must have Settings._internalSettings.entityToken set to call this method'
    const result = await MakeRequest<SetMatchmakingQueueResult>('/Match/SetMatchmakingQueue', request, 'X-EntityToken', Settings._internalSettings.entityToken)
    return result
}